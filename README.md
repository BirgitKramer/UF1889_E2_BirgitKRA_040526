...
### Decision funcional
Para estas practica se considera "cliente" a los registros del modelo `res.partner` con `customer_rank > 0`, y "seguimiènto" a los registros del modelo `mail.activity` asociados al cliente `res_model = 'res.partner'` y res_id=<id del cliente>`
